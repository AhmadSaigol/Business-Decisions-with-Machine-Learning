...
stores_tbl      <- read_excel(path  = "new_raw_data/Business Decisions with Machine Learning/breakfast_at_the_frat.xlsx", 
                              sheet = "dh Store Lookup",
                              skip  = 1)
products_tbl    <- read_excel(path  = "new_raw_data/Business Decisions with Machine Learning/breakfast_at_the_frat.xlsx", 
                              sheet = "dh Products Lookup",
                              skip  = 1)
transaction_tbl <- read_excel(path  = "new_raw_data/Business Decisions with Machine Learning/breakfast_at_the_frat.xlsx",
